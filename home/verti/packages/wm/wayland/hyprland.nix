...
in
{
  ...
  xdg.configFile."hypr/hyprland.lua".text = ''
    ...
    local colorscheme = {
      color1 = "rgb(${rgb theme.colors.blue})",
      color2 = "rgb(${rgb theme.colors.purple})",
      inactive = "rgb(${rgb theme.colors.background})"
    }
    ...
    hl.bind(mainMod .. " + F9", hl.dsp.exec_cmd('awww img -t none "$(shuf -n1 -e ~/Pictures/Wallpapers/*.{jpg,jpeg,png,gif,webp})"'))
